...
const Home = () => {
  ...
  return (
    <div className="font-sans bg-gray-900 sm:h-screen">
      ...
      <div className="max-w-4xl mx-auto p-6 rounded-lg mt-6 ">
        {activeTab === "home" && (
          <motion.div
          ...
          >
            <div className="text-white flex flex-col items-center justify-center">
              ...
              /> */}
              <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-gray-400">
                <Image
              ...
              <header className="text-center p-10">
                ...
                <p className="text-lg font-bold mt-2 px-20">
                  {resumeData.title}
                </p>
              </header>
